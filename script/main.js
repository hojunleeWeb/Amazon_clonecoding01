...
let sideMenuCloseBtn = document.getElementById("full_side_menu_close_btn");
...
//아무 변화가 없도록 보였는데 아마 openSideMenu()라고 작성할 경우 이것은 함수를 뜻하는것이 아니고 함수의 리턴값(위 함수는 리턴이 없긴하지만)
